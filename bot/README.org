...
curl -X POST https://alpyrbot.duckdns.org/webhook -d "DOGEUSDTPERP,buy,alert,1.943,"
...
curl -X POST https://127.0.0.1:5000/webhook -d "DOGEUSDTPERP,buy,enter,1.943,"
#+end_src
...
1. [[https://liquidation.atsutane.net/calc][Binance Minimum Trading Rules]]
...
4. tv_username_last_used => ~roxanroxanroxan_14~
5. yb digital card used: 3 times
   ending: ****
